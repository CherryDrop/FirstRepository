...
const HomeInfoPanel: React.FC = () => {
    return (
        <Flex width={'100%'} justifyContent={'space-between'} gap={10} className={styles['container']} marginBottom={20} marginTop={20}
            direction={['column', 'column', 'column', 'row']}
        >
            <Flex className={`${styles['container']} ${styles['feature-card']}`} gap={5}>
